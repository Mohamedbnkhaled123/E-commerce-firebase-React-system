                        ...
                        <ul className="mt-4 space-y-2 text-sm text-velora-text">
                            <li>
                                <a
                                    ...
                                    className="hover:text-velora transition-colors flex items-center gap-2"
                                >
                            ...
                            <li>
                                <a
                                    href="https://www.facebook.com/share/1FwaopCzHN/?mibextid=wwXIfr"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-velora transition-colors flex items-center gap-2"
                                >
